...
//		controller.turnLeft();
//		BoatState o = boat.getBoatState();
//		verify(boat).setBoatState(boatStateCaptor.capture());
//
//		assertEquals(o.getLeft(), boatStateCaptor.getValue());
//
//	}
//
//	@Test
...
//		controller.turnRight();
//		BoatState o = boat.getBoatState();
//		verify(boat).setBoatState(orientationCaptor.capture());
//
...
//		when(boat.getBoatState()).thenReturn(BoatState.UP);
...
//		TypeFactory tf = new TypeFactory();
//		Coordinate rc = tf.createCoordinate(0, 0);
//		when(boat.getBoatState()).thenReturn(BoatState.LEFT);
//		when(boat.getCoordinate()).thenReturn(rc);
//
//		when(elementRepository.getElements(any(Coordinate.class))).thenAnswer(new Answer<Set<Element>>() {
//
...
//		when(boat.getBoatState()).thenReturn(BoatState.DOWN);
//		when(boat.getCoordinate()).thenReturn(rc);
//
//		when(elementRepository.getElements(any(Coordinate.class))).thenAnswer(new Answer<Set<Element>>() {
//
...
//		TypeFactory tf = new TypeFactory();
//		Coordinate rc = tf.createCoordinate(4, 4);
//		when(boat.getBoatState()).thenReturn(BoatState.RIGHT);
//		when(boat.getCoordinate()).thenReturn(rc);
//
//		when(elementRepository.getElements(any(Coordinate.class))).thenAnswer(new Answer<Set<Element>>() {
//
...
//		TypeFactory tf = new TypeFactory();
//		BoatState orientation = BoatState.UP;
